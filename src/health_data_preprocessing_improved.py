...
heartrate_file = os.path.join(project_root, "data/raw/heart_rate_dataset_improved.csv")
temperature_file = os.path.join(project_root, "data/raw/temperature_dataset_improved.csv")
output_dir = os.path.join(project_root, "data/preprocessed_improved")
